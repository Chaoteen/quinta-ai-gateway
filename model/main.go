...
func migrateDB() error {
	...
	if err := migrateUserRoleKey(); err != nil {
		return err
	}
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&QuotaUsageRecord{}, "QuotaUsageRecord"},
		{&BillingRecord{}, "BillingRecord"},
		{&RevenueShareRule{}, "RevenueShareRule"},
		{&RevenueShareRecord{}, "RevenueShareRecord"},
...
` + "`monthly_price`" + ` decimal(10,6) NOT NULL DEFAULT 0,
` + "`yearly_price`" + ` decimal(10,6) NOT NULL DEFAULT 0,
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		{Name: "code", DDL: "`code` varchar(64) DEFAULT ''"},
		{Name: "name", DDL: "`name` varchar(128) DEFAULT ''"},
		{Name: "description", DDL: "`description` text"},
		{Name: "title", DDL: "`title` varchar(128) NOT NULL"},
		{Name: "subtitle", DDL: "`subtitle` varchar(255) DEFAULT ''"},
		{Name: "price_amount", DDL: "`price_amount` decimal(10,6) NOT NULL"},
		{Name: "currency", DDL: "`currency` varchar(8) NOT NULL DEFAULT 'USD'"},
		{Name: "monthly_price", DDL: "`monthly_price` decimal(10,6) NOT NULL DEFAULT 0"},
		{Name: "yearly_price", DDL: "`yearly_price` decimal(10,6) NOT NULL DEFAULT 0"},
		{Name: "duration_unit", DDL: "`duration_unit` varchar(16) NOT NULL DEFAULT 'month'"},
		{Name: "duration_value", DDL: "`duration_value` integer NOT NULL DEFAULT 1"},
		{Name: "custom_seconds", DDL: "`custom_seconds` bigint NOT NULL DEFAULT 0"},
		{Name: "enabled", DDL: "`enabled` numeric DEFAULT 1"},
		{Name: "status", DDL: "`status` varchar(32) DEFAULT 'enabled'"},
		...
		{Name: "token_quota", DDL: "`token_quota` bigint NOT NULL DEFAULT 0"},
		{Name: "request_quota", DDL: "`request_quota` bigint NOT NULL DEFAULT 0"},
		{Name: "model_quota", DDL: "`model_quota` text"},
