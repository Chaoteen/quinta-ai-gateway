...
const RankingsIndexRoute = RankingsIndexRouteImport.update({
  ...
  import('./routes/rankings/index.lazy').then((d) => d.Route),
)
...
const AuthenticatedChannelsIndexRoute =
  AuthenticatedChannelsIndexRouteImport.update({
    ...
    import('./routes/_authenticated/channels/index.lazy').then((d) => d.Route),
  )
...
const AuthenticatedModelsSectionRoute =
  AuthenticatedModelsSectionRouteImport.update({
    ...
    import('./routes/_authenticated/models/$section.lazy').then((d) => d.Route),
  )
...
const AuthenticatedDashboardSectionRoute =
  AuthenticatedDashboardSectionRouteImport.update({
    ...
    import('./routes/_authenticated/dashboard/$section.lazy').then(
      (d) => d.Route,
    ),
  )
...
const AuthenticatedAdminVouchersIndexRoute =
  AuthenticatedAdminVouchersIndexRouteImport.update({
    id: '/admin/vouchers/',
    path: '/admin/vouchers/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/distribution-channels/': {
      ...
      path: '/distribution-channels'
      fullPath: '/distribution-channels/'
      preLoaderRoute: typeof AuthenticatedDistributionChannelsIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/departments/': {
