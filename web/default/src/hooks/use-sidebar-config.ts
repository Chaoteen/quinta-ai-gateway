...
const URL_TO_CONFIG_MAP: Record<string, { section: string; module: string }> = {
  ...
  '/vouchers': { section: 'personal', module: 'voucher' },
  ...
  '/admin/vouchers': { section: 'admin', module: 'voucher' },
  '/admin/finance': { section: 'admin', module: 'finance' },
  '/admin/invoices': { section: 'admin', module: 'invoice' },
