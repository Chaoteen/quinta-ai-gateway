...
import (
	...
	"github.com/Chaoteen/quinta-ai-gateway/relay/channel/ai360"
	"github.com/Chaoteen/quinta-ai-gateway/relay/channel/lingyiwanwu"
	...
	"github.com/Chaoteen/quinta-ai-gateway/relay/helper"
	...
	if modelLimitEnable {
		...
		if tokenGroup == "auto" {
			for _, autoGroup := range service.GetUserAutoGroup(userGroup) {
				groupModels := model.GetGroupEnabledModels(autoGroup, scope)
			...
			models = model.GetGroupEnabledModels(group, scope)
		}
...
func EnabledListModels(c *gin.Context) {
	c.JSON(200, gin.H{
		"success": true,
		"data":    model.GetEnabledModels(model.TenantScopeFromContext(c)),
	})
}
